...
if __name__ == "__main__":
    ...
    ax.plot(source_data.index, source_data["E"], 'violet', alpha=0.5, lw=2, label='Exposed')
    ax.plot(source_data.index, predicted_data["E"], 'dodgerblue', alpha=0.9, lw=2, label='Exposed Prediction', linestyle='dashed')
    ...
    ax.plot(source_data.index, source_data["R"], 'blue', alpha=0.5, lw=2, label='Recovered')
    ax.plot(source_data.index, predicted_data["R"], 'teal', alpha=0.9, lw=2, label='Recovered Prediction', linestyle='dashed')
    ...
    print('R^2(R): {}'.format(round(m.r2_score(source_data["R"], predicted_data["R"]), 4)))

...
class PINN(nn.Module):
    ...
    def net_f(self, t_batch):
        ...
        logging.info("S_hat_t = {}, S_min = {}, S_max = {}, S_hat = {}".format(S_hat_t, self.S_min, self.S_max, S_hat))
    ...
    def train(self, n_epochs):
        ...
        for epoch in tqdm(range(n_epochs)):
            ...
            logging.info("F1 = {}, F2 = {}, F3 = {}, F4 = {}, S_pred = {}. E_pred = {}, I_pred = {}, R_pred = {}".format(
                f1, f2, f3, f4, S_pred, E_pred, I_pred, R_pred
            ))
            ...
            # calculate the loss
            loss = (torch.mean(torch.square(self.S_hat[0] - S_pred[0])) +

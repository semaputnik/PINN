...
if __name__ == "__main__":
    ...
    ax.plot(source_data["t"], source_data["S"], 'pink', alpha=0.5, lw=2, label='Susceptible')
    ax.plot(source_data["t"], predicted_data["S"], 'red', alpha=0.9, lw=2, label='Susceptible Prediction', linestyle='dashed')
